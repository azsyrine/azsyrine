    ...
    <>
      ...
      <div className="form_data">
        ...
        <form>
          ...
          <div className="form_input_files">
          ...
          <div className='form_message' >
            <p>Message</p>
            <textarea className='form_input_message' type="text" name="message" id="message" placeholder='Write here ....' />
          </div>
        <button className='btne' onSubmit={handleSubmit}>Send</button>
        </form>
